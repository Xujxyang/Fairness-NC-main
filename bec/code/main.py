...
def parse_arguments():
    ...
    parser.add_argument('--save_path', required=False, default='cased_ori_lr_2e-5_collect')
...
def fine_tune(model, dataloader, epochs, tokenizer, device):
    ...
    for epoch_i in range(0, epochs):
        ...
        # save_model(model, epoch_i, tokenizer, args)
...
if __name__ == '__main__':
    ...
    if args.tune:
        ...
        collect_embeddings(coll_args, model, tune_tokens)
        import pdb; pdb.set_trace()
