...
if [ $model_type == 'bert' ]; then
    local_model_name_or_path=bert-base-uncased
...
PLOT_DATA=../sentence_collection/$local_model_name_or_path/$bias/word_correlation/word_data.bin      #word_correlation/word_data.bin
OUTPUT_DIR=../debiased_models/$seed/$local_model_name_or_path/$algorithm/$bias/herself+mather-nc3
