...
class DataArguments:
    ...
    data_dir: Optional[str] = field(
        default=None,
        metadata={
            "help": "The directory of the saved dataset (for the datasets library)."
        },
    )
...
def get_data_as_chunks(
    args: DataArguments, cache_dir: str, token: str
) -> Dict[str, Dataset]:
    """
    ...
    if args.data_dir is not None and exists(args.data_dir):
        ...
        raw_datasets = load_dataset('json', data_files=args.data_dir)
    elif args.dataset_name is not None:
        raw_datasets = load_dataset("roneneldan/TinyStories")
    elif args.dataset_name is not None:
        # Downloading and loading a dataset from the hub.
        args.dataset_config_name = 'data'
